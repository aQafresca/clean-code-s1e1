...
var taskInput=document.getElementById("todo__input_new");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("todo__list_incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("todo__list_completed");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='todo__item-text todo__label-text';

    //Each elements, needs appending
    checkBox.className = 'todo__input-checkbox';
    checkBox.type = "checkbox";
    editInput.type = "text";
    editInput.className = "todo__item-text todo__input-text";
    ...
    deleteButtonImg.className = 'todo__button-image';
...
var editTask=function(){
    ...
    var label=listItem.querySelector(".todo__label-text");
